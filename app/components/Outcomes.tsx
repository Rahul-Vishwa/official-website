        ...
        <section className="padding-x mb-20">
            ...
            <div className="mt-5 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
                <div className="group relative bg-black rounded-xl text-white p-8 pb-30 overflow-hidden">
                    ...
                    <div className="text-xl font-semibold">Turn AI into real business outcomes</div>
                ...
                <div className="group relative bg-black rounded-xl text-white p-8 pb-30 overflow-hidden">
                    ...
                    <div className="text-xl font-semibold">Unlock proprietary knowledge</div>
                ...
                <div className="group relative bg-black rounded-xl text-white p-8 pb-30 overflow-hidden">
                    ...
                    <div className="text-xl font-semibold">Reduce manual work at scale</div>
