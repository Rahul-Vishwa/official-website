    ...
    return (
        <section className="padding-x pb-20">
            ...
            <div className="mt-10 columns-1 sm:columns-2 lg:columns-4 gap-5">
                ...
                <div className="break-inside-avoid mb-5 p-6 bg-white rounded-xl border border-neutral-300 flex flex-col justify-between">
                    <div>
                        ...
                        could understand. The final result exceeded our expectations, and we plan to collaborate again soon.
                    </div>

                    <div className="flex gap-3 mt-5">
                        <div className="w-10 h-10 overflow-hidden relative rounded-full">
                            <img src="/profile.jpg" className="absolute w-full h-full object-cover object-top" />
                        </div>
                        <div className="text-[13px] flex flex-col justify-center">
                            <div className="font-semibold">Rahul Vishwa</div>
                            <div>Technologia Institutia</div>
                        </div>
                    </div>
                </div>
