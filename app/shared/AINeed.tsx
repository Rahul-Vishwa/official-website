        ...
        <section className="padding-x mb-24">
            ...
            <div className="mt-10">
                <div className="grid grid-cols-6 gap-5">
                    {/* <div className="col-span-4 flex gap-4 text-black w-full p-8 bg-gray-card rounded-xl">
                        <div>
                    ...
                    <div className="col-span-2 text-black w-full p-8 overflow-hidden bg-gray-card rounded-xl relative">
                    ...
                    <div className="col-span-2 text-black w-full p-8 bg-gray-card rounded-xl">
                        <div className="mb-4">
                            <div className="">
