        ...
        <section className="padding-x mb-20">
            ...
            <div className="mt-10">
                <div className="grid grid-cols-6 gap-5">
                    <div className="col-span-4 flex gap-4 text-black w-full p-8 bg-gray-card border border-neutral-300 rounded-xl">
                        <div>
                    ...
                    <div className="col-span-2 text-black w-full p-8 overflow-hidden bg-gray-card border border-neutral-300 rounded-xl relative">
                    ...
                    <div className="col-span-2 text-black w-full p-8 bg-gray-card border border-neutral-300 rounded-xl">
                        <div className="mb-4">
                            <div className="">
                    ...
                    <div className="col-span-2 text-black w-full p-8 bg-gray-card border border-neutral-300 rounded-xl">
                        <div className="mb-4">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" fill="none" stroke="url(#grad)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="12" x2="12" y1="2" y2="22" stroke="#3B5BDB" /><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" /></svg>
                        </div>
