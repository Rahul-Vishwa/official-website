        ...
        <section className="padding-x mb-24">
            ...
            <div className="mt-10">
                <div className="grid grid-cols-6 gap-5">
                    <div className="col-span-2 text-black w-full p-8 bg-gray-card rounded-xl border border-transparent transition-all duration-300 ease-in-out hover:border hover:border-blue-600">
                        <div className="mb-4">
                            <div className="">
